...
import static in.enzen.taskforum.rest.BaseUrl.sSafetyWork;
...
public class OnMSafetyWorkActivity extends AppCompatActivity {
    ...
    private EditText etNoOfLocation, etFeederName, etDtrName, etshortDetailsOfWorkDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_msafety_work);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("SAFETY WORK");
        ...
        etNoOfLocation = findViewById(R.id.etNoOfLocation);
        etFeederName = findViewById(R.id.etFeederName);
        etDtrName = findViewById(R.id.etDtrName);
        etshortDetailsOfWorkDone = findViewById(R.id.etshortDetailsOfWorkDone);
        ...
        etNoOfLocation.setTypeface(appFontRegular2);
        etFeederName.setTypeface(appFontRegular2);
        etDtrName.setTypeface(appFontRegular2);
        etshortDetailsOfWorkDone.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMSafetyWorkActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMSafetyWorkActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMSafetyWorkActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMSafetyWorkActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMSafetyWorkActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMSafetyWorkActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMSafetyWorkActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMSafetyWorkActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNoOfLocation.setText("");
        etFeederName.setText("");
        etDtrName.setText("");
        etshortDetailsOfWorkDone.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMSafetyWorkActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sSafetyWork,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_of_location", etNoOfLocation.getText().toString());
                params.put("name_of_11kv_fdr_cover", etFeederName.getText().toString());
                params.put("name_of_dtr", etDtrName.getText().toString());
                params.put("detail_work", etshortDetailsOfWorkDone.getText().toString());
