...
import static in.enzen.taskforum.rest.BaseUrl.sInstallVerificationCOM;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;

@SuppressWarnings("ALL")
public class ComInstalltionVerificationActivity extends AppCompatActivity {
    ...
    private EditText etGenVerification, etConsumerGrevience, etLDConsumerVisited, etGhostConsumerVisited;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_installtion_verification);
        init();
    }
    ...
    private void init() {
        ...
        etGenVerification = findViewById(R.id.etGenVerification);
        etConsumerGrevience = findViewById(R.id.etConsumerGrevience);
        etLDConsumerVisited = findViewById(R.id.etLDConsumerVisited);
        etGhostConsumerVisited = findViewById(R.id.etGhostConsumerVisited);
        ...
        etGenVerification.setTypeface(appFontRegular2);
        etConsumerGrevience.setTypeface(appFontRegular2);
        etLDConsumerVisited.setTypeface(appFontRegular2);
        etGhostConsumerVisited.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComInstalltionVerificationActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComInstalltionVerificationActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComInstalltionVerificationActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComInstalltionVerificationActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComInstalltionVerificationActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComInstalltionVerificationActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComInstalltionVerificationActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComInstalltionVerificationActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etGenVerification.setText("");
        etConsumerGrevience.setText("");
        etLDConsumerVisited.setText("");
        etGhostConsumerVisited.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComInstalltionVerificationActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sInstallVerificationCOM,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("general_verification", etGenVerification.getText().toString());
                params.put("for_consumer_grevience", etConsumerGrevience.getText().toString());
                params.put("ld_consumer_visited", etLDConsumerVisited.getText().toString());
                params.put("ghost_consumer_visited", etGhostConsumerVisited.getText().toString());
