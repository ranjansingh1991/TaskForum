...
import static in.enzen.taskforum.rest.BaseUrl.sSDORecoveryAssesment;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("ALL")
public class SdoRecoveryAssessmentActivity extends AppCompatActivity {
    ...
    EditText etAssAmtRecovered, etNoOfCasesRecovered;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recovery_assessment);
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("RECOVERY ASSESSMENT");
        ...
        etAssAmtRecovered = findViewById(R.id.etAssAmtRecovered);
        etNoOfCasesRecovered = findViewById(R.id.etNoOfCasesRecovered);
        ...
        etAssAmtRecovered.setTypeface(appFontRegular2);
        etNoOfCasesRecovered.setTypeface(appFontRegular2);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoRecoveryAssessmentActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoRecoveryAssessmentActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoRecoveryAssessmentActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoRecoveryAssessmentActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoRecoveryAssessmentActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoRecoveryAssessmentActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoRecoveryAssessmentActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sSDORecoveryAssesment,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ass_amt_recovered", etAssAmtRecovered.getText().toString());
                params.put("amt_ no_of_cases_recovered", etNoOfCasesRecovered.getText().toString());
    ...
    private void doReset() {
        etAssAmtRecovered.setText("");
        etNoOfCasesRecovered.setText("");
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoRecoveryAssessmentActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoRecoveryAssessmentActivity.this, SplashActivity.class));
                    }
                })
