...
import static in.enzen.taskforum.rest.BaseUrl.sNewConnection;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("ALL")
public class OnMNewConnectionVerification extends AppCompatActivity {
    ...
    private EditText etExistingConnectionVerified, etIrregularityFound, etIrregularityRectified,
            etNewConnectionRejected, etPrmisesVerified;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_connection_verification);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("NEW CONNECTION");
        ...
        etPrmisesVerified = findViewById(R.id.etPrmisesVerified);
        etExistingConnectionVerified = findViewById(R.id.etExistingConnectionVerified);
        etIrregularityFound = findViewById(R.id.etIrregularityFound);
        etIrregularityRectified = findViewById(R.id.etIrregularityRectified);
        etNewConnectionRejected = findViewById(R.id.etNewConnectionRejected);
        ...
        etIrregularityRectified.setTypeface(appFontRegular2);
        etIrregularityFound.setTypeface(appFontRegular2);
        etExistingConnectionVerified.setTypeface(appFontRegular2);
        etPrmisesVerified.setTypeface(appFontRegular2);
        etNewConnectionRejected.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMNewConnectionVerification.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMNewConnectionVerification.this, SplashActivity.class));
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMNewConnectionVerification.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMNewConnectionVerification.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMNewConnectionVerification.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMNewConnectionVerification.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMNewConnectionVerification.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMNewConnectionVerification.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etExistingConnectionVerified.setText("");
        etIrregularityFound.setText("");
        etIrregularityRectified.setText("");
        etNewConnectionRejected.setText("");
        etPrmisesVerified.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMNewConnectionVerification.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sNewConnection,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("connection_verified", etExistingConnectionVerified.getText().toString());
                params.put("iregularity_found", etIrregularityFound.getText().toString());
                params.put("iregularity_rectified", etIrregularityRectified.getText().toString());
                params.put("new_premises_verified", etPrmisesVerified.getText().toString());
                params.put("new_connection_rejected", etNewConnectionRejected.getText().toString());
