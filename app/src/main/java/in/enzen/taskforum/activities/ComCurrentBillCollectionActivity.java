...
import static in.enzen.taskforum.rest.BaseUrl.sCurrentBill;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;

@SuppressWarnings("ALL")
public class ComCurrentBillCollectionActivity extends AppCompatActivity {
    ...
    private TextInputLayout tilNoOfMoneyReceipt, tilCollectionAmount;
    private EditText etCollectionAmount, etNoOfMoneyReceipt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_current_bill_collection);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("Current Bill Collection");
        ...
        tilNoOfMoneyReceipt = findViewById(R.id.tilNoOfMoneyReceipt);
        tilCollectionAmount = findViewById(R.id.tilCollectionAmount);
        etNoOfMoneyReceipt = findViewById(R.id.etNoOfMoneyReceipt);
        etCollectionAmount = findViewById(R.id.etCollectionAmount);
        ...
        tilNoOfMoneyReceipt.setTypeface(appFontRegular2);
        tilCollectionAmount.setTypeface(appFontRegular2);
        etNoOfMoneyReceipt.setTypeface(appFontRegular2);
        etCollectionAmount.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComCurrentBillCollectionActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComCurrentBillCollectionActivity.this, SplashActivity.class));
                    }
                })
 ...
 // create alert dialog
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComCurrentBillCollectionActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComCurrentBillCollectionActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComCurrentBillCollectionActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComCurrentBillCollectionActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComCurrentBillCollectionActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComCurrentBillCollectionActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNoOfMoneyReceipt.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComCurrentBillCollectionActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sCurrentBill,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("collection_amount", etCollectionAmount.getText().toString());
                params.put("No_of_mr", etNoOfMoneyReceipt.getText().toString());
