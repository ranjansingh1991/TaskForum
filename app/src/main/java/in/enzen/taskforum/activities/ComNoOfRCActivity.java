...
import static in.enzen.taskforum.rest.BaseUrl.sNoOfRC;
...
public class ComNoOfRCActivity extends AppCompatActivity {
    ...
    private  TextInputLayout tillNoOfRcDom,tilLRcOtherThanDom;
    private EditText etNoOfRcDom, etRcOtherThanDom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_no_of_rc);
        init();
    }
    ...
    private void init() {
        ...
        tillNoOfRcDom = findViewById(R.id.tillNoOfRcDom);
        tilLRcOtherThanDom = findViewById(R.id.tilLRcOtherThanDom);
        tilLRcOtherThanDom.setTypeface(appFontRegular2);
        tillNoOfRcDom.setTypeface(appFontRegular2);
        etNoOfRcDom = findViewById(R.id.etNoOfRcDom);
        etRcOtherThanDom = findViewById(R.id.etRcOtherThanDom);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComNoOfRCActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComNoOfRCActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComNoOfRCActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComNoOfRCActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComNoOfRCActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComNoOfRCActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComNoOfRCActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComNoOfRCActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNoOfRcDom.setText("");
        etRcOtherThanDom.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComNoOfRCActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sNoOfRC,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_of_rc_dom", etNoOfRcDom.getText().toString());
                params.put("no_rc_other_dom", etRcOtherThanDom.getText().toString());
