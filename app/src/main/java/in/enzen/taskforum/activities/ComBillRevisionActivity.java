...
import static in.enzen.taskforum.rest.BaseUrl.sComBillRevision;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("ALL")
public class ComBillRevisionActivity extends AppCompatActivity {
    ...
    EditText etAmtRecoveredInRs, etNoOfCases;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_bill_revision);
        init();
    }
    ...
    private void init() {
        ...
        etAmtRecoveredInRs = findViewById(R.id.etAmtRecoveredInRs);
        etNoOfCases = findViewById(R.id.etNoOfCases);
        ...
        etNoOfCases.setTypeface(appFontRegular2);
        etAmtRecoveredInRs.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComBillRevisionActivity.this);
        // set title
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                               new PreferencesManager(getApplicationContext()).setLoggedIn(false);
                                startActivity(new Intent(ComBillRevisionActivity.this, SplashActivity.class));
                            }
                        })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComBillRevisionActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComBillRevisionActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComBillRevisionActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComBillRevisionActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComBillRevisionActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComBillRevisionActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNoOfCases.setText("");
        etAmtRecoveredInRs.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComBillRevisionActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sComBillRevision,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("amt_recovery", etAmtRecoveredInRs.getText().toString());
                params.put("no_of_cases", etNoOfCases.getText().toString());
