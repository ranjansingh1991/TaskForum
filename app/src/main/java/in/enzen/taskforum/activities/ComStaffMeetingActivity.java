...
import static in.enzen.taskforum.rest.BaseUrl.sMeetingCOM;
...
public class ComStaffMeetingActivity extends AppCompatActivity {
    ...
    private EditText etBillingMeeting, etCollectionMeeting, etVillageMeeting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_staff_meeting);
        init();
    }
    ...
    private void init() {
        ...
        etVillageMeeting = findViewById(R.id.etVillageMeeting);
        ...
        etVillageMeeting.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComStaffMeetingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComStaffMeetingActivity.this, SplashActivity.class));
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(ComStaffMeetingActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(ComStaffMeetingActivity.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComStaffMeetingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComStaffMeetingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComStaffMeetingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComStaffMeetingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComStaffMeetingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComStaffMeetingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sMeetingCOM,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("village_meeting", etVillageMeeting.getText().toString());
