...
import static in.enzen.taskforum.rest.BaseUrl.sCollectionAgainstRC;
...
public class ComArrearCollectionAgainstRCActivity extends AppCompatActivity {
    ...
    private TextInputLayout tillAmtRecoveredRCDom, tilLAmtRecoveredRCOtherThenDom;
    private EditText etAmtRecoveredRCDom, etAmtRecoveredRCOtherThenDom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_arrear_collection_against_rc);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("ARREAR COLLECTION AGAINST RC");
        ...
        tillAmtRecoveredRCDom = findViewById(R.id.tillAmtRecoveredRCDom);
        tilLAmtRecoveredRCOtherThenDom = findViewById(R.id.tilLAmtRecoveredRCOtherThenDom);
        tillAmtRecoveredRCDom.setTypeface(appFontRegular2);
        tilLAmtRecoveredRCOtherThenDom.setTypeface(appFontRegular2);

        etAmtRecoveredRCDom = findViewById(R.id.etAmtRecoveredRCDom);
        etAmtRecoveredRCOtherThenDom = findViewById(R.id.etAmtRecoveredRCOtherThenDom);
        etAmtRecoveredRCDom.setTypeface(appFontRegular2);
        etAmtRecoveredRCOtherThenDom.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComArrearCollectionAgainstRCActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComArrearCollectionAgainstRCActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComArrearCollectionAgainstRCActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComArrearCollectionAgainstRCActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComArrearCollectionAgainstRCActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComArrearCollectionAgainstRCActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComArrearCollectionAgainstRCActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComArrearCollectionAgainstRCActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etAmtRecoveredRCDom.setText("");
        etAmtRecoveredRCOtherThenDom.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComArrearCollectionAgainstRCActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sCollectionAgainstRC,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("amt_rcv_rc_dom", etAmtRecoveredRCDom.getText().toString());
                params.put("amt_rcv_rc_other_dom", etAmtRecoveredRCOtherThenDom.getText().toString());
