...
import static in.enzen.taskforum.rest.BaseUrl.sMeetingMRT;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("ALL")
public class MrtStaffMeetingActivity extends AppCompatActivity {
    ...
    private EditText etSafetyMeeting, etMRTMeeting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mrt_staff_meeting);
        init();
    }
    ...
    private void init() {
        ...
        etMRTMeeting = findViewById(R.id.etMRTMeeting);
        ...
        etMRTMeeting.setTypeface(appFontRegular2);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(MrtStaffMeetingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(MrtStaffMeetingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(MrtStaffMeetingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(MrtStaffMeetingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(MrtStaffMeetingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(MrtStaffMeetingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MrtStaffMeetingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(MrtStaffMeetingActivity.this, SplashActivity.class));
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(MrtStaffMeetingActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(MrtStaffMeetingActivity.this);
    ...
    private void doSubmit() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sMeetingMRT,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("safety_staff", etSafetyMeeting.getText().toString());
                params.put("mrt_meeting", etMRTMeeting.getText().toString());
