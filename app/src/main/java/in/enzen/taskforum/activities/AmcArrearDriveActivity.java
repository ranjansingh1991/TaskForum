...
public class AmcArrearDriveActivity extends AppCompatActivity implements KeyNames {
    ...
    private EditText etNoticeServed, etConsumerVisited, etConsumerPaid, etArrearAmount, etCommitmentDone, etCommitmentAmount,
            etPowerDisconnected, ConsumerFoundLD, etGhostConsumerFound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amc_arrear_drive);
        init();
    }
    ...
    private void init() {
        ...
        ConsumerFoundLD = findViewById(R.id.ConsumerFoundLD);
        ...
        ConsumerFoundLD.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AmcArrearDriveActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(AmcArrearDriveActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(AmcArrearDriveActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(AmcArrearDriveActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(AmcArrearDriveActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AmcArrearDriveActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(AmcArrearDriveActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(AmcArrearDriveActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        ConsumerFoundLD.setText("");
        etGhostConsumerFound.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(AmcArrearDriveActivity.this, "Please wait...");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sArrearDriveAll,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_of_con_found_ld", ConsumerFoundLD.getText().toString());
