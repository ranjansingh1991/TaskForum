...
public class AmcPhaseMeterReadingActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amc_phase_meter_reading);
        init();
    }
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AmcPhaseMeterReadingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(AmcPhaseMeterReadingActivity.this, SplashActivity.class));
                    }
                })
    ...
    public void onLocationChanged(Location location) {
        ...
        tvLocation.setText(getApplicationContext().getString(R.string.location) + " " + dLatitute + ", " + dLongitute);
    }
