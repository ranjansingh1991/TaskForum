...
import static in.enzen.taskforum.rest.BaseUrl.sMeterReading;
...
public class MrtPhaseMeterReading extends AppCompatActivity {
    ...
    private TextInputLayout tilNoOfReadingTaken;
    private TextInputLayout tilNoOfDefectiveMeter;
    private TextInputLayout tilNoOfUnauthorisedFound;
    private EditText etNoOfReadingTaken;
    private EditText etNoOfDefectiveMeter;
    private EditText etNoOfUnauthorisedFound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mrt_phase_meter_reading);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("3 PH METER READING");
        ...
        tilNoOfReadingTaken = findViewById(R.id.tilNoOfReadingTaken);
        tilNoOfDefectiveMeter = findViewById(R.id.tilNoOfDefectiveMeter);
        tilNoOfUnauthorisedFound = findViewById(R.id.tilNoOfUnauthorisedFound);
        etNoOfReadingTaken = findViewById(R.id.etNoOfReadingTaken);
        etNoOfDefectiveMeter = findViewById(R.id.etNoOfDefectiveMeter);
        etNoOfUnauthorisedFound = findViewById(R.id.etNoOfUnauthorisedFound);
        btnSubmit = findViewById(R.id.btnSubmit);
        btnReset = findViewById(R.id.btnReset);

        tilNoOfReadingTaken.setTypeface(appFontRegular2);
        tilNoOfDefectiveMeter.setTypeface(appFontRegular2);
        tilNoOfUnauthorisedFound.setTypeface(appFontRegular2);
        etNoOfReadingTaken.setTypeface(appFontRegular2);
        etNoOfDefectiveMeter.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MrtPhaseMeterReading.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(MrtPhaseMeterReading.this, SplashActivity.class));
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(MrtPhaseMeterReading.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(MrtPhaseMeterReading.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(MrtPhaseMeterReading.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(MrtPhaseMeterReading.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(MrtPhaseMeterReading.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(MrtPhaseMeterReading.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(MrtPhaseMeterReading.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sMeterReading,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_reading_taken", etNoOfReadingTaken.getText().toString());
                params.put("no_unauthorised_found", etNoOfUnauthorisedFound.getText().toString());
                params.put("no_meter_defect", etNoOfDefectiveMeter.getText().toString());
    ...
    private void doReset() {
        ...
        etNoOfReadingTaken.setText("");
        etNoOfDefectiveMeter.setText("");
