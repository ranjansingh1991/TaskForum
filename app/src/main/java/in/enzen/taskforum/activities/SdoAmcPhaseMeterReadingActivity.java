...
public class SdoAmcPhaseMeterReadingActivity extends AppCompatActivity {
    ...
    private EditText etSdoReadingTaken, etSdoDefective, etSdoUnauthorisedFound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdo_phase_meter_reading);
        init();
    }
    ...
    private void init() {
        ...
        etSdoReadingTaken = findViewById(R.id.etSdoReadingTaken);
        etSdoDefective = findViewById(R.id.etSdoDefective);
        etSdoUnauthorisedFound = findViewById(R.id.etSdoUnauthorisedFound);
        ...
        etSdoReadingTaken.setTypeface(appFontRegular2);
        etSdoDefective.setTypeface(appFontRegular2);
        etSdoUnauthorisedFound.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoAmcPhaseMeterReadingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoAmcPhaseMeterReadingActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoAmcPhaseMeterReadingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoAmcPhaseMeterReadingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoAmcPhaseMeterReadingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoAmcPhaseMeterReadingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoAmcPhaseMeterReadingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoAmcPhaseMeterReadingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoAmcPhaseMeterReadingActivity.this, "Please wait...");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sMeterReading,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_reading_taken", etSdoReadingTaken.getText().toString());
                params.put("no_unauthorised_found", etSdoUnauthorisedFound.getText().toString());
                params.put("no_meter_defect", etSdoDefective.getText().toString());
    ...
    private void doReset() {
        ...
        etSdoReadingTaken.setText("");
        etSdoDefective.setText("");
        etSdoUnauthorisedFound.setText("");
    }
}
