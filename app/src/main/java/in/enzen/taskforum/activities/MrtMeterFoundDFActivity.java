...
import static in.enzen.taskforum.rest.BaseUrl.sMeterDefective;
...
public class MrtMeterFoundDFActivity extends AppCompatActivity {
    ...
    private TextInputLayout tilMeterFoundDf, tilNoOfMeterFoundDfToDf, tilAdditionalLoad, tilNOOfCasesAdditionalLoad;
    private EditText etMeterFoundOkToDf, etNoOfMeterFoundDfToDf, etAdditionalLoad, etNOOfCasesAdditionalLoad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mrt_meter_found_df);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("METER FOUND DF");
        ...
        tilMeterFoundDf = findViewById(R.id.tilMeterFoundDf);
        tilNoOfMeterFoundDfToDf = findViewById(R.id.tilNoOfMeterFoundDfToDf);
        tilAdditionalLoad = findViewById(R.id.tilAdditionalLoad);
        tilNOOfCasesAdditionalLoad = findViewById(R.id.tilNOOfCasesAdditionalLoad);

        tilMeterFoundDf.setTypeface(appFontRegular2);
        tilNoOfMeterFoundDfToDf.setTypeface(appFontRegular2);
        tilAdditionalLoad.setTypeface(appFontRegular2);
        tilNOOfCasesAdditionalLoad.setTypeface(appFontRegular2);

        etNoOfMeterFoundDfToDf = findViewById(R.id.etNoOfMeterFoundDfToDf);
        etMeterFoundOkToDf = findViewById(R.id.etMeterFoundOkToDf);
        etAdditionalLoad = findViewById(R.id.etAdditionalLoad);
        etNOOfCasesAdditionalLoad = findViewById(R.id.etNOOfCasesAdditionalLoad);

        etNoOfMeterFoundDfToDf.setTypeface(appFontRegular2);
        etNoOfMeterFoundDfToDf.setTypeface(appFontRegular2);
        etAdditionalLoad.setTypeface(appFontRegular2);
        etNOOfCasesAdditionalLoad.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MrtMeterFoundDFActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(MrtMeterFoundDFActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(MrtMeterFoundDFActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(MrtMeterFoundDFActivity.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(MrtMeterFoundDFActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(MrtMeterFoundDFActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(MrtMeterFoundDFActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(MrtMeterFoundDFActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(MrtMeterFoundDFActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(MrtMeterFoundDFActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(MrtMeterFoundDFActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sMeterDefective,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("nos_of_mtr_found_ok_2_df", etMeterFoundOkToDf.getText().toString());
                params.put("nos_of_mtr_found_df_2_df", etNoOfMeterFoundDfToDf.getText().toString());
                params.put("addition_load_kw_found", etAdditionalLoad.getText().toString());
                params.put("nos_of_cases_with_addn_load", etNOOfCasesAdditionalLoad.getText().toString());
    ...
    private void doReset() {
        ...
        etMeterFoundOkToDf.setText("");
        etNoOfMeterFoundDfToDf.setText("");
        etAdditionalLoad.setText("");
        etNOOfCasesAdditionalLoad.setText("");
