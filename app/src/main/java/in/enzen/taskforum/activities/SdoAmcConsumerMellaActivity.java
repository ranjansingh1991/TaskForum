...
import static in.enzen.taskforum.rest.BaseUrl.sConsumerMella;
...
public class SdoAmcConsumerMellaActivity extends AppCompatActivity {
    ...
    private EditText etFeederName, etDtrName, etDtrLocation, etCapacity, etVillageName, etNewConnectionReceived, etApplicationRejected,
            etPowerSupplyGiven, etReceived, etResolved;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdo_consumer_mella);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("CONSUMER MELLA");
        ...
        etNewConnectionReceived = findViewById(R.id.etNewConnectionReceived);
        etApplicationRejected = findViewById(R.id.etApplicationRejected);
        etPowerSupplyGiven = findViewById(R.id.etPowerSupplyGiven);
        etReceived = findViewById(R.id.etReceived);
        etResolved = findViewById(R.id.etResolved);
        ...
        etNewConnectionReceived.setTypeface(appFontRegular2);
        etApplicationRejected.setTypeface(appFontRegular2);
        etPowerSupplyGiven.setTypeface(appFontRegular2);
        etReceived.setTypeface(appFontRegular2);
        etResolved.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoAmcConsumerMellaActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoAmcConsumerMellaActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(SdoAmcConsumerMellaActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(SdoAmcConsumerMellaActivity.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoAmcConsumerMellaActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoAmcConsumerMellaActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoAmcConsumerMellaActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoAmcConsumerMellaActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoAmcConsumerMellaActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoAmcConsumerMellaActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNewConnectionReceived.setText("");
        etApplicationRejected.setText("");
        etPowerSupplyGiven.setText("");
        etReceived.setText("");
        etResolved.setText("");
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoAmcConsumerMellaActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sConsumerMella,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("new_application_connection_received", etNewConnectionReceived.getText().toString());
                params.put("New_application_connection_rejected", etApplicationRejected.getText().toString());
                params.put("Power_supply_given", etPowerSupplyGiven.getText().toString());
                params.put("Commercial_complained_received", etReceived.getText().toString());
                params.put("Commercial_complained_resolved", etResolved.getText().toString());
                params.put("picture_during_mella", sImageBase64);
