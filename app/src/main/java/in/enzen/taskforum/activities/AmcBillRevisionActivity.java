...
import static in.enzen.taskforum.rest.BaseUrl.sBillRevision;
...
public class AmcBillRevisionActivity extends AppCompatActivity {
    ...
    private EditText etAmcBillComplaintReceived, etAmcBillRevisionDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amc_bill_revision);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("BILL REVISION");
        ...
        etAmcBillComplaintReceived = findViewById(R.id.etAmcBillComplaintReceived);
        etAmcBillRevisionDone = findViewById(R.id.etAmcBillRevisionDone);
        ...
        etAmcBillRevisionDone.setTypeface(appFontRegular2);
        etAmcBillComplaintReceived.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AmcBillRevisionActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(AmcBillRevisionActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(AmcBillRevisionActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(AmcBillRevisionActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(AmcBillRevisionActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AmcBillRevisionActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(AmcBillRevisionActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(AmcBillRevisionActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etAmcBillRevisionDone.setText("");
        etAmcBillComplaintReceived.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(AmcBillRevisionActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sBillRevision,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("bill_complaint_received", etAmcBillComplaintReceived.getText().toString());
                params.put("bill_revision_done", etAmcBillRevisionDone.getText().toString());
