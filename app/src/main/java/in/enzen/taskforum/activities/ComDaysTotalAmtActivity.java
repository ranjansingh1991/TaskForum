...
import static in.enzen.taskforum.rest.BaseUrl.sDayTotalCollectionAmount;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("ALL")
public class ComDaysTotalAmtActivity extends AppCompatActivity {
    ...
    private EditText etTotalDayCollection, etNoOfTotalMr, etCollectionFromArrear, etNoOfMrForArrear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_days_total_amt);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("TOTAL COLLECTION AMOUNT ");
        ...
        etTotalDayCollection = findViewById(R.id.etTotalDayCollection);
        etNoOfTotalMr = findViewById(R.id.etNoOfTotalMr);
        etCollectionFromArrear = findViewById(R.id.etCollectionFromArrear);
        etNoOfMrForArrear = findViewById(R.id.etNoOfMrForArrear);
        ...
        etTotalDayCollection.setTypeface(appFontRegular2);
        etNoOfTotalMr.setTypeface(appFontRegular2);
        etCollectionFromArrear.setTypeface(appFontRegular2);
        etNoOfMrForArrear.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComDaysTotalAmtActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComDaysTotalAmtActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComDaysTotalAmtActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComDaysTotalAmtActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComDaysTotalAmtActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComDaysTotalAmtActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComDaysTotalAmtActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComDaysTotalAmtActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etTotalDayCollection.setText("");
        etNoOfTotalMr.setText("");
        etCollectionFromArrear.setText("");
        etNoOfMrForArrear.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComDaysTotalAmtActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sDayTotalCollectionAmount,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ttl_Col_day", etTotalDayCollection.getText().toString());
                params.put("no_of_ttl_mr", etNoOfTotalMr.getText().toString());
                params.put("coll_from_arrear", etCollectionFromArrear.getText().toString());
                params.put("nos_mr_frm_arrear", etNoOfMrForArrear.getText().toString());
