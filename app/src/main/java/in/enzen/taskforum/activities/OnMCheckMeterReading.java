...
import static in.enzen.taskforum.rest.BaseUrl.sCheckMeterReading;
...
public class OnMCheckMeterReading extends AppCompatActivity {
    ...
    EditText etTotalNo, etNoOfSupressCasesFound, etfoundSupress, etNoMtrDefFound, etNoMeterDBFound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_omcheck_meter_reading);
        init();
    }
    ...
    private void init() {
        ...
        etTotalNo = findViewById(R.id.etTotalNo);
        etNoOfSupressCasesFound = findViewById(R.id.etNoOfSupressCasesFound);
        etfoundSupress = findViewById(R.id.etfoundSupress);
        etNoMtrDefFound = findViewById(R.id.etNoMtrDefFound);
        etNoMeterDBFound = findViewById(R.id.etNoMeterDBFound);
        ...
        etTotalNo.setTypeface(appFontRegular2);
        etNoOfSupressCasesFound.setTypeface(appFontRegular2);
        etfoundSupress.setTypeface(appFontRegular2);
        etNoMtrDefFound.setTypeface(appFontRegular2);
        etNoMeterDBFound.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMCheckMeterReading.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMCheckMeterReading.this, SplashActivity.class));
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(OnMCheckMeterReading.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(OnMCheckMeterReading.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMCheckMeterReading.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMCheckMeterReading.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMCheckMeterReading.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMCheckMeterReading.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMCheckMeterReading.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMCheckMeterReading.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etTotalNo.setText("");
        etNoOfSupressCasesFound.setText("");
        etfoundSupress.setText("");
        etNoMtrDefFound.setText("");
        etNoMeterDBFound.setText("");
        imgSnap.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_image_add_dark_holo_64));
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMCheckMeterReading.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sCheckMeterReading,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("total_no", etTotalNo.getText().toString());
                params.put("supress_reading_cases_found", etNoOfSupressCasesFound.getText().toString());
                params.put("total_units_found_supress", etfoundSupress.getText().toString());
                params.put("mtr_def_cases_found", etNoMtrDefFound.getText().toString());
                params.put("no_of_mtr_replaced", etNoMeterDBFound.getText().toString());
