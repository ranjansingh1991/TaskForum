...
public class AmcInstalltionVerfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amc_installtion_verf);
        init();
    }
        ...
        switch (view.getId()) {
            case R.id.rbLT:
                if (checked)
                    ...
                    Toast.makeText(AmcInstalltionVerfActivity.this, "You selected LT", Toast.LENGTH_SHORT).show();
            ...
            case R.id.rbHT:
                if (checked)
                    ...
                    Toast.makeText(AmcInstalltionVerfActivity.this, "You selected HT", Toast.LENGTH_SHORT).show();
    ...
    public void onHtCategoryClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.rbHtSIN:
                if (checked)
                    Toast.makeText(AmcInstalltionVerfActivity.this, "You selected SIN", Toast.LENGTH_SHORT).show();
                llEntryFields.setVisibility(View.VISIBLE);
                break;
            case R.id.rbHtMIN:
                if (checked)
                    Toast.makeText(AmcInstalltionVerfActivity.this, "You selected MIN", Toast.LENGTH_SHORT).show();
                llEntryFields.setVisibility(View.VISIBLE);
                break;
            case R.id.rbHtLIN:
                if (checked)
                    Toast.makeText(AmcInstalltionVerfActivity.this, "You selected LIN", Toast.LENGTH_SHORT).show();
                llEntryFields.setVisibility(View.VISIBLE);
                break;
        }
    }
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AmcInstalltionVerfActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(AmcInstalltionVerfActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(AmcInstalltionVerfActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(AmcInstalltionVerfActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(AmcInstalltionVerfActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AmcInstalltionVerfActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(AmcInstalltionVerfActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(AmcInstalltionVerfActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(AmcInstalltionVerfActivity.this, "Please wait...");
