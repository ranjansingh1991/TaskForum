...
import static in.enzen.taskforum.rest.BaseUrl.sCollectionTarget;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;

@SuppressWarnings("ALL")
public class FirstPhaseActivity extends AppCompatActivity {
    ...
    TextView tv1PH;
    private EditText etDayCollection, etDayArrear, etMoneyReceipt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_phase);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("1 PH Collection Target");
        ...
        etMoneyReceipt = findViewById(R.id.etMoneyReceipt);
        etDayArrear = findViewById(R.id.etDayArrear);
        etDayCollection = findViewById(R.id.etDayCollection);
        etDayCollection.setTypeface(appFontRegular2);
        etDayArrear.setTypeface(appFontRegular2);
        etMoneyReceipt.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FirstPhaseActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(FirstPhaseActivity.this, SplashActivity.class));
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(FirstPhaseActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(FirstPhaseActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(FirstPhaseActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(FirstPhaseActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(FirstPhaseActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(FirstPhaseActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(FirstPhaseActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sCollectionTarget,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("total_arrear", etDayArrear.getText().toString());
                params.put("no_mon_rec", etMoneyReceipt.getText().toString());
