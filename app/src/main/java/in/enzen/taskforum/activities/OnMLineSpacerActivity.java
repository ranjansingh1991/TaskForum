...
import static in.enzen.taskforum.rest.BaseUrl.sLineSpacer;
...
public class OnMLineSpacerActivity extends AppCompatActivity {
    ...
    private EditText etTotalNo, etFeederName, etFeederCovered, etDtrCovered, etDtrName, etSpaceSaidDtr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_mline_spacer);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("LINE SPACER");
        ...
        etFeederCovered = findViewById(R.id.etFeederCovered);
        etDtrCovered = findViewById(R.id.etDtrCovered);
        etDtrName = findViewById(R.id.etDtrName);
        etSpaceSaidDtr = findViewById(R.id.etSpaceSaidDtr);
        ...
        etFeederCovered.setTypeface(appFontRegular2);
        etDtrCovered.setTypeface(appFontRegular2);
        etDtrName.setTypeface(appFontRegular2);
        etSpaceSaidDtr.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMLineSpacerActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMLineSpacerActivity.this, SplashActivity.class));
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(OnMLineSpacerActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(OnMLineSpacerActivity.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMLineSpacerActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMLineSpacerActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMLineSpacerActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMLineSpacerActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMLineSpacerActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMLineSpacerActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etFeederCovered.setText("");
        etDtrCovered.setText("");
        etDtrName.setText("");
        etSpaceSaidDtr.setText("");
        imgSnap.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_image_add_dark_holo_64));
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMLineSpacerActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sLineSpacer,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("name_of_11kv_fdr_cover", etFeederCovered.getText().toString());
                params.put("name_of_11kv_feeder", etFeederName.getText().toString());
                params.put("no_of_dtr_cover", etDtrCovered.getText().toString());
                params.put("name_of_dtr", etDtrName.getText().toString());
                params.put("no_of_said_dtr", etSpaceSaidDtr.getText().toString());
