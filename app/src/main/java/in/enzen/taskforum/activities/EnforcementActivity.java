...
import static in.enzen.taskforum.rest.BaseUrl.sEnforcement;
...
public class EnforcementActivity extends AppCompatActivity {
    ...
    private EditText etTotalCount, etAssessment;
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("Enforcement");
        ...
        etAssessment.setTypeface(appFontRegular2);
        etTotalCount.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EnforcementActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(EnforcementActivity.this, SplashActivity.class));
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(EnforcementActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(EnforcementActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(EnforcementActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(EnforcementActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(EnforcementActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(EnforcementActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(EnforcementActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sEnforcement,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("total_count", etTotalCount.getText().toString());
                params.put("assessment_value", etAssessment.getText().toString());
    ...
    private void doReset() {
        ...
        etTotalCount.setText("");
        etAssessment.setText("");
    }
