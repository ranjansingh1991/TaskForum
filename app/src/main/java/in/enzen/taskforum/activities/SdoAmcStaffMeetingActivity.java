...
import static in.enzen.taskforum.rest.BaseUrl.sSdoStaffMeeting;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;

@SuppressWarnings("All")


public class SdoAmcStaffMeetingActivity extends AppCompatActivity {
    ...
    private TextInputLayout tilSelectDate, tilSelectTime, tilSafetyMeeting, tilBillingMeeting, tilCollectionMeeting;
    private EditText etSafetyMeeting, etBillingMeeting, etCollectionMeeting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdo_staff_meeting);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("STAFF MEETING");
        ...
        tilBillingMeeting = findViewById(R.id.tilBillingMeeting);
        tilCollectionMeeting = findViewById(R.id.tilCollectionMeeting);
        tilSafetyMeeting = findViewById(R.id.tilSafetyMeeting);
        etSafetyMeeting = findViewById(R.id.etSafetyMeeting);
        etBillingMeeting = findViewById(R.id.etBillingMeeting);
        etCollectionMeeting = findViewById(R.id.etCollectionMeeting);
        btnSubmit = findViewById(R.id.btnSubmit);
        btnReset = findViewById(R.id.btnReset);
        btnSubmit.setTypeface(appFontRegular2);
        btnReset.setTypeface(appFontRegular2);
        tilCollectionMeeting.setTypeface(appFontRegular2);
        tilBillingMeeting.setTypeface(appFontRegular2);
        tilSafetyMeeting.setTypeface(appFontRegular2);
        etCollectionMeeting.setTypeface(appFontRegular2);
        etBillingMeeting.setTypeface(appFontRegular2);
        etSafetyMeeting.setTypeface(appFontRegular2);
    ...
    private void doReset() {
        ...
        etSafetyMeeting.setText("");
        etBillingMeeting.setText("");
        etCollectionMeeting.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoAmcStaffMeetingActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sSdoStaffMeeting,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("ground_staff", etSafetyMeeting.getText().toString());
                params.put("billing_meeting", etBillingMeeting.getText().toString());
                params.put("collection_meeting", etCollectionMeeting.getText().toString());
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoAmcStaffMeetingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoAmcStaffMeetingActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoAmcStaffMeetingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoAmcStaffMeetingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoAmcStaffMeetingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoAmcStaffMeetingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoAmcStaffMeetingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoAmcStaffMeetingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(SdoAmcStaffMeetingActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(SdoAmcStaffMeetingActivity.this);
