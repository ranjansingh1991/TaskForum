...
import static in.enzen.taskforum.rest.BaseUrl.sTemporaryConnection;
...
public class OnMTemporaryConnectionVerification extends AppCompatActivity {
    ...
    private EditText etTCVerified, etUnauthorisedTCFound, etSpotPenaltyCollected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temporary_connection_verification);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("Temporary Connection");
        ...
        etTCVerified = findViewById(R.id.etTCVerified);
        etSpotPenaltyCollected = findViewById(R.id.etSpotPenaltyCollected);
        etUnauthorisedTCFound = findViewById(R.id.etUnauthorisedTCFound);
        ...
        etTCVerified.setTypeface(appFontRegular2);
        etUnauthorisedTCFound.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMTemporaryConnectionVerification.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMTemporaryConnectionVerification.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMTemporaryConnectionVerification.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMTemporaryConnectionVerification.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMTemporaryConnectionVerification.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMTemporaryConnectionVerification.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMTemporaryConnectionVerification.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMTemporaryConnectionVerification.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMTemporaryConnectionVerification.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sTemporaryConnection,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_tc_verified", etTCVerified.getText().toString());
                params.put("unauthorised_found", etUnauthorisedTCFound.getText().toString());
                params.put("penalty_charge_collected", etSpotPenaltyCollected.getText().toString());
    ...
    private void doReset() {
        ...
        etTCVerified.setText("");
        etUnauthorisedTCFound.setText("");
