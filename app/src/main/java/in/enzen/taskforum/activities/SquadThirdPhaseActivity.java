...
import static in.enzen.taskforum.rest.BaseUrl.sDisconnectionSquad;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;

@SuppressWarnings("ALL")
public class SquadThirdPhaseActivity extends AppCompatActivity {
    ...
    private TextView tv3PH;
    private EditText etDayDisconnection, etDayReconnection, etDDRealisation, etDayMoneyReceipt, etDayCollection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squad_third_phase);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("3 PH Target");
        ...
        tv3PH = findViewById(R.id.tv3PH);
        etDayDisconnection = findViewById(R.id.etDayDisconnection);
        etDayReconnection = findViewById(R.id.etDayReconnection);
        etDDRealisation = findViewById(R.id.etDDRealisation);
        etDayMoneyReceipt = findViewById(R.id.etDayMoneyReceipt);
        etDayCollection = findViewById(R.id.etDayCollection);
        btnSubmit = findViewById(R.id.btnSubmit);
        btnReset = findViewById(R.id.btnReset);
        tv3PH.setTypeface(appFontRegular2);
        etDayDisconnection.setTypeface(appFontRegular2);
        etDayReconnection.setTypeface(appFontRegular2);
        etDDRealisation.setTypeface(appFontRegular2);
        etDayMoneyReceipt.setTypeface(appFontRegular2);
        etDayCollection.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SquadThirdPhaseActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SquadThirdPhaseActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SquadThirdPhaseActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SquadThirdPhaseActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SquadThirdPhaseActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SquadThirdPhaseActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SquadThirdPhaseActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SquadThirdPhaseActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SquadThirdPhaseActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sDisconnectionSquad,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("total_realisation", etDDRealisation.getText().toString());
                params.put("no_disconnection", etDayDisconnection.getText().toString());
                params.put("no_reconnection", etDayReconnection.getText().toString());
                params.put("total_collection", etDayCollection.getText().toString());
                params.put("no_mony_rec", etDayMoneyReceipt.getText().toString());
                params.put("token", new PreferencesManager(getApplicationContext()).getString("token"));
                params.put("type", tv3PH.getText().toString());
