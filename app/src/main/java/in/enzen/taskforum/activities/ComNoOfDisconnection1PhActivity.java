...
import static in.enzen.taskforum.rest.BaseUrl.sDisconnection1Phase;
...
public class ComNoOfDisconnection1PhActivity extends AppCompatActivity {
    ...
    private TextInputLayout tillNoOfDcDom,tilAmtOfDcCom,tilLDcOtherThanDom,tilAmtOfDcOtherDom;
    private EditText etNoOfDcDom, etAmtOfDcCom, etDcOtherThanDom, etAmtOfDcOtherDom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_no_of_disconnection1_ph);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("DISCONNECTION 1PH");
        ...
        tillNoOfDcDom = findViewById(R.id.tillNoOfDcDom);
        tilAmtOfDcCom = findViewById(R.id.tilAmtOfDcCom);
        tilLDcOtherThanDom = findViewById(R.id.tilLDcOtherThanDom);
        tilAmtOfDcOtherDom = findViewById(R.id.tilAmtOfDcOtherDom);

        tillNoOfDcDom.setTypeface(appFontRegular2);
        tilAmtOfDcCom.setTypeface(appFontRegular2);
        tilLDcOtherThanDom.setTypeface(appFontRegular2);
        tilAmtOfDcOtherDom .setTypeface(appFontRegular2);

        etNoOfDcDom = findViewById(R.id.etNoOfDcDom);
        etAmtOfDcCom = findViewById(R.id.etAmtOfDcCom);
        etDcOtherThanDom = findViewById(R.id.etDcOtherThanDom);
        etAmtOfDcOtherDom = findViewById(R.id.etAmtOfDcOtherDom);

        etAmtOfDcCom.setTypeface(appFontRegular2);
        etDcOtherThanDom.setTypeface(appFontRegular2);
        etNoOfDcDom.setTypeface(appFontRegular2);
        etAmtOfDcOtherDom.setTypeface(appFontRegular2);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComNoOfDisconnection1PhActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(ComNoOfDisconnection1PhActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(ComNoOfDisconnection1PhActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(ComNoOfDisconnection1PhActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(ComNoOfDisconnection1PhActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ComNoOfDisconnection1PhActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(ComNoOfDisconnection1PhActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(ComNoOfDisconnection1PhActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etNoOfDcDom.setText("");
        etAmtOfDcCom.setText("");
        etDcOtherThanDom.setText("");
        etAmtOfDcOtherDom.setText("");
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ComNoOfDisconnection1PhActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sDisconnection1Phase,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_of_dc_dom", etNoOfDcDom.getText().toString());
                params.put("amt_of_dc_dom", etAmtOfDcCom.getText().toString());
                params.put("no_dc_other_dom", etDcOtherThanDom.getText().toString());
                params.put("amt_of_dc_other_dom", etAmtOfDcOtherDom.getText().toString());
