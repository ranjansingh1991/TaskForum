...
import static in.enzen.taskforum.rest.BaseUrl.sTreeTrimming;
import static in.enzen.taskforum.utils.Constraints.PROGRESS_DIALOG_BG_COLOR;


@SuppressWarnings("All")

public class OnMTreeTrimmingActivity extends AppCompatActivity {
    ...
    private RadioButton rbLT, rbHT;
    private LinearLayout llHTAttributes, llLTAttributes, llPictureParent;
    private EditText etHtFeederName, etNoOfSpan, etLocationFrom, etCapacity, etPLBTriming,
            etLocationTo, etLtFeederName, etDtrName, etDtrLocation, etB1, etR1, etY1, etN1, etTreeTrimingSpan,
            etTreeming, etR2, etY2, etB2, etN2;

    private TextView tvImageTitleBefore, tvImageTitleAfter, tvAttachSnapPathBefore, tvAttachSnapPathAfter;
    private ImageView imgSnapBefore, imgSnapAfter;

    private Uri mImageCaptureUriBefore = null;
    private Uri mImageCaptureUriAfter = null;
    private String sImageBase64Before = "";
    private String sImageBase64After = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_mtree_tree_ming);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("TREE TREEMING");
        ...
        llHTAttributes = findViewById(R.id.llHTAttributes);
        llLTAttributes = findViewById(R.id.llLTAttributes);
        llPictureParent = findViewById(R.id.llPictureParent);
        etTreeTrimingSpan = findViewById(R.id.etTreeTrimingSpan);
        etTreeming = findViewById(R.id.etTreeming);
        rbLT = findViewById(R.id.rbLT);
        rbHT = findViewById(R.id.rbHT);
        tvImageTitleBefore = findViewById(R.id.tvImageTitleBefore);
        tvImageTitleAfter = findViewById(R.id.tvImageTitleAfter);
        tvAttachSnapPathBefore = findViewById(R.id.tvAttachSnapPathBefore);
        tvAttachSnapPathAfter = findViewById(R.id.tvImageTitleAfter);
        tvAttachSnapPathBefore.setTypeface(appFontRegular2);
        tvAttachSnapPathAfter.setTypeface(appFontRegular2);
        etHtFeederName = findViewById(R.id.etHtFeederName);
        etLtFeederName = findViewById(R.id.etLtFeederName);
        etDtrName = findViewById(R.id.etDtrName);
        etDtrLocation = findViewById(R.id.etDtrLocation);
        etCapacity = findViewById(R.id.etCapacity);
        etNoOfSpan = findViewById(R.id.etNoOfSpan);
        etLocationFrom = findViewById(R.id.etLocationFrom);
        etLocationTo = findViewById(R.id.etLocationTo);
        etPLBTriming = findViewById(R.id.etPLBTriming);
        ...
        imgSnapBefore = findViewById(R.id.imgSnapBefore);
        imgSnapAfter = findViewById(R.id.imgSnapAfter);
        ...
        tvImageTitleBefore.setTypeface(appFontRegular2);
        tvImageTitleAfter.setTypeface(appFontRegular2);
        etHtFeederName.setTypeface(appFontRegular2);
        etLtFeederName.setTypeface(appFontRegular2);
        ...
        imgSnapBefore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                mImageCaptureUriBefore = Uri.parse("file:///sdcard/photo.jpg");
                intent.putExtra(android.provider.MediaStore.EXTRA_OUTPUT, mImageCaptureUriBefore);
                startActivityForResult(intent, CAMERA);
            }
        });

        imgSnapAfter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                mImageCaptureUriAfter = Uri.parse("file:///sdcard/photo.jpg");
                intent.putExtra(android.provider.MediaStore.EXTRA_OUTPUT, mImageCaptureUriAfter);
                startActivityForResult(intent, CAMERA);
            }
        });
        ...
        switch (view.getId()) {
            case R.id.rbLT:
                if (checked)
                    ...
                    Toast.makeText(OnMTreeTrimmingActivity.this, "You selected LT", Toast.LENGTH_SHORT).show();
                llLTAttributes.setVisibility(View.VISIBLE);
                llHTAttributes.setVisibility(View.GONE);
                llPictureParent.setVisibility(View.VISIBLE);
                break;
            case R.id.rbHT:
                if (checked)
                    // First open HT category option then in Option selected display the entry fields.
                    Toast.makeText(OnMTreeTrimmingActivity.this, "You selected HT", Toast.LENGTH_SHORT).show();
                llLTAttributes.setVisibility(View.GONE);
                llHTAttributes.setVisibility(View.VISIBLE);
                llPictureParent.setVisibility(View.VISIBLE);
                break;
        }
    }
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMTreeTrimmingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMTreeTrimmingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMTreeTrimmingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMTreeTrimmingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMTreeTrimmingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMTreeTrimmingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doReset() {
        ...
        etHtFeederName.setText("");
        etNoOfSpan.setText("");
        etLocationFrom.setText("");
        etCapacity.setText("");
        etPLBTriming.setText("");
        etLocationTo.setText("");
        etLtFeederName.setText("");
        etDtrName.setText("");
        ...
        etY1.setText("");
        etN1.setText("");
        etTreeTrimingSpan.setText("");
        etTreeming.setText("");
        etR2.setText("");
        etY2.setText("");
        etB2.setText("");
        etN2.setText("");
        imgSnapBefore.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_image_add_dark_holo_64));
        imgSnapAfter.setImageDrawable(getApplicationContext().getResources().getDrawable(R.drawable.ic_image_add_dark_holo_64));
    }

    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMTreeTrimmingActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sTreeTrimming,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if (rbLT.isChecked()) {
                    params.put("type", rbLT.getText().toString());
                    params.put("feeder_name", etLtFeederName.getText().toString());
                    ...
                    params.put("peak_load_before", etPLBTriming.getText().toString());
                    ...
                    params.put("no_trimming_span", etTreeTrimingSpan.getText().toString());
                    params.put("peak_load_after", etTreeming.getText().toString());
                    ...
                    params.put("picture_before", sImageBase64Before);
                    params.put("picture_after", sImageBase64After);
                } else {
                    params.put("type", rbHT.getText().toString());
                    params.put("feeder_name", etHtFeederName.getText().toString());
                    params.put("no_trimming_span", etNoOfSpan.getText().toString());
                    params.put("picture_before", sImageBase64Before);
                    params.put("picture_after", sImageBase64After);
                    params.put("location_to", etLocationTo.getText().toString());
                    params.put("location_from", etLocationFrom.getText().toString());
                }
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMTreeTrimmingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMTreeTrimmingActivity.this, SplashActivity.class));
                    }
                })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA && resultCode == RESULT_OK) {
            try {
                ...
                tvAttachSnapPathBefore.setText(R.string.image_selected);
                tvAttachSnapPathAfter.setText(R.string.image_selected);

                mImageCaptureUriBefore = Uri.fromFile(file);
                mImageCaptureUriAfter = Uri.fromFile(file);
            ...
            if (outPutFile.exists()) {
                ...
                imgSnapBefore.setImageBitmap(photo);
                imgSnapAfter.setImageBitmap(photo);
                tvAttachSnapPathAfter.setText(R.string.image_selected);
                tvAttachSnapPathBefore.setText(R.string.image_selected);
                sImageBase64Before = encodeImageToBase64(photo);
                sImageBase64After = encodeImageToBase64After(photo);
            } else {
    ...
    private String encodeImageToBase64After(Bitmap bitmap) {
        System.gc();
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.PNG, 50, bos);
        byte[] bb = bos.toByteArray();
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            intent.setData(mImageCaptureUriBefore);
            intent.setData(mImageCaptureUriAfter);
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(OnMTreeTrimmingActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(OnMTreeTrimmingActivity.this);
                ...
                builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    ...
                    public void onCancel(DialogInterface dialog) {
                        if (mImageCaptureUriAfter != null) {
                            getContentResolver().delete(mImageCaptureUriAfter, null, null);
                            mImageCaptureUriAfter = null;
                        }
                    }
                });
                ...
                builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    @Override
                    public void onCancel(DialogInterface dialog) {
                        if (mImageCaptureUriBefore != null) {
                            getContentResolver().delete(mImageCaptureUriBefore, null, null);
                            mImageCaptureUriBefore = null;
                        }
                    }
                });
