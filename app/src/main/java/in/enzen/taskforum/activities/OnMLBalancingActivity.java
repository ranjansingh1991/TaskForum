...
public class OnMLBalancingActivity extends AppCompatActivity {
    ...
    private EditText etFeederName, etDtrName, etDtrLocation, etCapacity, etPLBSanitising, etR1, etY1, etB1, etN1,
            etPeakLoadBalancing, etR2, etY2, etB2, etN2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_mlbalancing);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("LOAD BALANCING");
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OnMLBalancingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(OnMLBalancingActivity.this, SplashActivity.class));
    ...
    private void cropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                CropingOptionAdapter adapter = new CropingOptionAdapter(OnMLBalancingActivity.this, cropOptions);
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(OnMLBalancingActivity.this);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(OnMLBalancingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(OnMLBalancingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(OnMLBalancingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(OnMLBalancingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(OnMLBalancingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OnMLBalancingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(OnMLBalancingActivity.this, "Please wait...");
