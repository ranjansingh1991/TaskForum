...
import static in.enzen.taskforum.rest.BaseUrl.sAuditReporting;
...
public class SdoEnergyReportingActivity extends AppCompatActivity {
    ...
    private EditText etNoOFFDRAudited, etNoOfDTRAudited;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdo_energy_reporting);
        init();
    }
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("ENERGY REPORTING");
        ...
        etNoOfDTRAudited = findViewById(R.id.etNoOFFDRAudited);
        etNoOFFDRAudited = findViewById(R.id.etNoOFFDRAudited);
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoEnergyReportingActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoEnergyReportingActivity.this, SplashActivity.class));
                    }
                })
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoEnergyReportingActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoEnergyReportingActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoEnergyReportingActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoEnergyReportingActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoEnergyReportingActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoEnergyReportingActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoEnergyReportingActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sAuditReporting,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_fdr_audited", etNoOFFDRAudited.getText().toString());
                params.put("no_dtr_audited", etNoOfDTRAudited.getText().toString());
    ...
    private void doReset() {
        etNoOFFDRAudited.setText("");
        etNoOfDTRAudited.setText("");
