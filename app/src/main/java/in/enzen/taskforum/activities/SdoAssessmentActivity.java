...
import static in.enzen.taskforum.rest.BaseUrl.sSDOAssessment;
...
public class SdoAssessmentActivity extends AppCompatActivity {
    ...
    private EditText etNOOfPRovAssRaised, etAmtOfprovAss, etNoOfFinalAssRaised, etAmtOfFinalAssd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdo_assessment);
    ...
    private void init() {
        ...
        tvToolbarTitle.setText("ASSESSMENT");
        ...
        etNOOfPRovAssRaised = findViewById(R.id.etNOOfPRovAssRaised);
        etAmtOfprovAss = findViewById(R.id.etAmtOfprovAss);
        etNoOfFinalAssRaised = findViewById(R.id.etNoOfFinalAssRaised);
        etAmtOfFinalAssd = findViewById(R.id.etAmtOfFinalAssd);
    ...
    private void startSOS() {
        //Check Permission
        checkPermissions();
        Intent intent = new Intent(SdoAssessmentActivity.this, SOSActivity.class);
        startActivity(intent);
    }

    private void initGoogleAPIClient() {
        //Without Google API Client Auto Location Dialog will not work
        mGoogleApiClient = new GoogleApiClient.Builder(SdoAssessmentActivity.this).addApi(LocationServices.API).build();
        mGoogleApiClient.connect();
    }

    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(SdoAssessmentActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(SdoAssessmentActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(SdoAssessmentActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(SdoAssessmentActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void doSubmit() {
        final ProgressDialog mProgressDialog = new ProgressDialog(SdoAssessmentActivity.this, "Please wait...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(PROGRESS_DIALOG_BG_COLOR));
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sSDOAssessment,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("no_prov_ass_raised", etNOOfPRovAssRaised.getText().toString());
                params.put("amt_ of_prov_ass", etAmtOfprovAss.getText().toString());
                params.put("no_of_final_ass_raised", etNoOfFinalAssRaised.getText().toString());
                params.put("amt_of_final_ass", etAmtOfFinalAssd.getText().toString());
    ...
    private void doReset() {
        etNOOfPRovAssRaised.setText("");
        etAmtOfprovAss.setText("");
        etNoOfFinalAssRaised.setText("");
        etAmtOfFinalAssd.setText("");
    ...
    public void showLogoutAlertDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SdoAssessmentActivity.this);
        // set title
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        startActivity(new Intent(SdoAssessmentActivity.this, SplashActivity.class));
                    }
                })
