...
import in.enzen.taskforum.calendar.formats.ArrayWeekDayFormatter;
import in.enzen.taskforum.calendar.formats.DateFormatTitleFormatter;
import in.enzen.taskforum.calendar.formats.DayFormatter;
import in.enzen.taskforum.calendar.formats.MonthArrayTitleFormatter;
import in.enzen.taskforum.calendar.formats.TitleChanger;
import in.enzen.taskforum.calendar.formats.TitleFormatter;
import in.enzen.taskforum.calendar.formats.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.ic_keyboard_arrow_left_white_24px);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.ic_keyboard_arrow_right_white_24px);
            }
