package in.enzen.taskforum.indicator;
...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, 0xA8FF3D00);
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            Class<?> drawableClass = Class.forName("in.enzen.taskforum.indicator.LineScaleIndicator");
